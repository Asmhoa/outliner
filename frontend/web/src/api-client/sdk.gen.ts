 ...
 */
export const updateBlockPositionDbDbIdBlocksPositionPut = <ThrowOnError extends boolean = false>(options: Options<UpdateBlockPositionDbDbIdBlocksPositionPutData, ThrowOnError>) => {
    return (options.client ?? client).put<UpdateBlockPositionDbDbIdBlocksPositionPutResponses, UpdateBlockPositionDbDbIdBlocksPositionPutErrors, ThrowOnError>({
 ...
 */
export const searchDbDbIdSearchPost = <ThrowOnError extends boolean = false>(options: Options<SearchDbDbIdSearchPostData, ThrowOnError>) => {
    return (options.client ?? client).post<SearchDbDbIdSearchPostResponses, SearchDbDbIdSearchPostErrors, ThrowOnError>({
        url: '/db/{db_id}/search',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const rebuildSearchDbDbIdRebuildSearchPost = <ThrowOnError extends boolean = false>(options: Options<RebuildSearchDbDbIdRebuildSearchPostData, ThrowOnError>) => {
    return (options.client ?? client).post<RebuildSearchDbDbIdRebuildSearchPostResponses, RebuildSearchDbDbIdRebuildSearchPostErrors, ThrowOnError>({
